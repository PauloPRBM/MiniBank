...
public class TransferController {
    ...
    public ResponseEntity<List<Transaction>> getMovimentacoes(@PathVariable UUID accountId) {
        return ResponseEntity.ok(transferService.getMovimentacoes(accountId));
    }
}